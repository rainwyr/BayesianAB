---
title: "Expected Loss Based Analysis"
author: "Rain"
date: "5/27/2021"
output: pdf_document
---
...
| 5       | Revenue          | Bernoulli-Exponential | False   | 0.001              |
| 6       | Revenue          | Bernoulli-Exponential | True    | 0.001              |
...
case_df <- rbind(cbind(case = 1, analyze_peeking(get_relevant_data(1))),
                 ...
                 cbind(case = 5, analyze_peeking(get_relevant_data(5))))
kable(case_df)
```
...
case_df <- rbind(cbind(case = 1, analyze_sample_size(get_relevant_data(1))),
                 ...
                 cbind(case = 5, analyze_sample_size(get_relevant_data(5))))
kable(case_df)
```
...
case_df <- rbind(cbind(case = 2, analyze_sample_size(get_relevant_data(2))),
                 ...
                 cbind(case = 6, analyze_sample_size(get_relevant_data(6))))
...
case_df <- rbind(cbind(case = 1, analyze_prior(get_relevant_data(1))),
                 ...
                 cbind(case = 5, analyze_prior(get_relevant_data(5))),
                 cbind(case = 6, analyze_prior(get_relevant_data(6))))
kable(case_df)
```